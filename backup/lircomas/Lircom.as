...
public class Lircom extends JFrame {
	...
	private var jContentPane:javax.swing.JPanel= null;
	 ...
	 */
	public function Lircom(title:String) {
		super(title);
		initialize();
	}
	/**
	 ...
	 */
	private function getJContentPane():javax.swing.JPanel {
		if(jContentPane == null) {
			var gridBagConstraints4:GridBagConstraints= new GridBagConstraints();
			var gridBagConstraints3:GridBagConstraints= new GridBagConstraints();
			var gridBagConstraints2:GridBagConstraints= new GridBagConstraints();
	 ...
	 */    
	private function getJJMenuBar():JMenuBar {
		if (jJMenuBar == null) {
	 ...
	 */    
	private function getJMenu():JMenu {
		if (jMenu == null) {
			jMenu = new JMenu();
			jMenu.setName("File");
		}
	 ...
	 */    
	private function getChat_Info_Area():JEditorPane {
	 ...
	 */    
	private function getChat_Text_Field():JTextField {
	 ...
	 */    
	private function getMember_List():JList {
		if (member_List == null) {
	...
	args = chatargs;
		...
		try {
			var lircomwindow:Lircom= new Lircom("Lircom");
	...
	private var chat_Info_Area:JEditorPane= null;
	private var chat_Text_Field:JTextField= null;
	private var member_List:JList= null;
