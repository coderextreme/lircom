...
public class Orbit4 {
  ...
  private JPanel addWindow(boolean bunny) {
    ...
    if (bunny) {
      inner.add(canvas, BorderLayout.CENTER);
    } else {
      ...
      inner.add(gradientPanel, BorderLayout.CENTER);
      ...
      inner.add(checkBox, BorderLayout.SOUTH);
    }

    inner.setSize(800, 600);
