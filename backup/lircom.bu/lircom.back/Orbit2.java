...
public class Orbit2 extends Thread {
  ...
  public Orbit2(JComponent component) {
  ...
  public void run() {
    ...
    component.add(canvas, javax.swing.JLayeredPane.PALETTE_LAYER);
	     ...
	     float specr, float specg, float specb, float shine)
{
	...
	gl.glMaterialfv(frontback, GL.GL_SPECULAR, new float[] {specr, specg, specb, 1.0f });
