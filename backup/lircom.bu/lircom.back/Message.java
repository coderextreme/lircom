...
public class Message extends Throwable {
    String from = "";
    java.util.Hashtable rec = new java.util.Hashtable();
    ...
    public Message(java.util.Hashtable rec, String nick, String message) {
	this.rec = rec;
        this.from = "";
        this.nick = nick;
    ...
    public Message(String to, String nick, String message) {
	this((java.util.Hashtable)null, nick, message);
        rec = new java.util.Hashtable();
	rec.put(to, to);
    }
    public Message(String to, String nick, String error, String message) {
	this(to, nick, message);
	this.error = error;
    }
