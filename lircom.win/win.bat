...
jar -xf lircom.zip
set CLASSPATH=%HOME%\lircom\target\lircom-2.jar;%HOME%\lircom\m2\httpunit-1.7.3.jar;%HOME%\lircom\m2\log4j-core-2.17.0.jar;%HOME%\lircom\m2\log4j-api-2.17.0.jar;%HOME%\lircom\m2\nekohtml-1.9.22.jar;%HOME%\lircom\m2\xercesImpl-2.11.0.jar;%HOME%\lircom\m2\rhino-1.7R4.jar;%HOME%\lircom\m2\json-20190722.jar
